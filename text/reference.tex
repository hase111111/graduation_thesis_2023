...
\begin{thebibliography}{99}
    ...
    \bibitem{cita:satou_tripod_gait}
    佐藤，井上:
    ...
    \bibitem{cita:wettergreen_tripod_gait}
    ...
    \bibitem{cita:google_cpp_style_guide}
    Google：
